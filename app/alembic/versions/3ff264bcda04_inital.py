...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name_en", sqlmodel.sql.sqltypes.AutoString(length=128), nullable=True
        ),
        sa.Column(
            "name_it", sqlmodel.sql.sqltypes.AutoString(length=128), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "currency",
            sa.Enum("EUR", "USD", "AUD", "CAD", "GBP", name="currency"),
            nullable=True,
        ),
        sa.Column(
            "created_at",
        ...
        sa.Column("country_id", sa.Integer(), nullable=False),
        sa.Column(
            "affiliate_query_param", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "search_next_page", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "search_page_param", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "product_name_class", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("product_name_css_is_class", sa.Boolean(), nullable=False),
        sa.Column(
            "product_name_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "product_price_class", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("product_price_css_is_class", sa.Boolean(), nullable=False),
        sa.Column(
            "product_price_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "product_image_class", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("product_image_css_is_class", sa.Boolean(), nullable=False),
        sa.Column(
            "product_image_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "product_thumb_class", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("product_thumb_css_is_class", sa.Boolean(), nullable=False),
        sa.Column(
            "product_thumb_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "product_variations_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "product_description_tag", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["country_id"],
            ["country.id"],
    ...
    op.create_index(
        "ix_product", "product", ["__ts_vector__"], unique=False, postgresql_using="gin"
    )
    op.create_table(
        "shipping_method",
        sa.Column(
            "currency",
            postgresql.ENUM("EUR", "USD", "AUD", "CAD", "GBP", name="currency"),
            nullable=True,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "search_query", sqlmodel.sql.sqltypes.AutoString(length=512), nullable=False
        ),
